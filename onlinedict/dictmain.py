...
class DictDialog(QDialog):
    def __init__(self, word):
        ...
        self.connect(self.frm.comboBox, SIGNAL("currentIndexChanged(int)"), self.changeDictEngine)
    ...
    def setupDictEngine(self):
        self.frm.comboBox.addItems([DictInfos[e]["name"] for e in self.engines])
...
def onShowDict():
    ...
    dlgExitShortcut.connect(dlgExitShortcut, SIGNAL("activated()"), dlg, SLOT("close()"))
    dlg.exec_()
    dlg=None
